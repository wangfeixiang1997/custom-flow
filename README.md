...
1. 自定义流程图：[LogicFlow](https://github.com/didi/LogicFlow)
   ...
   ```ruby
    ...
    ```
2. 自定义表单：[schema-builder](https://xrender.fun/schema-builder)
    1. 代码示例
    ```ruby
    // 引入SchemaBuilder
    ...
    <SchemaBuilder
        defaultValue={schemaData[nodeId]}
        importBtn={true}
        exportBtn={true}
        pubBtn={false}
        saveBtn={{
            onClick: (schema) => {
                schemaData[nodeId] = schema
...
logicflow.getGraphData()
{
    ...
    "nodes":[
        {
            // 元素唯一值
            "id":"fa8b58ef-42e5-49a7-9a31-30f45ed402d1",
            // 元素类型
            "type":"circle",
            "x":400,
            "y":220,
        ...
        {
            "id":"2fc38a13-121a-4834-8ee0-ef4a86533c29",
            "type":"rect",
            "x":640,
            "y":220,
            "properties":{
    ...
    "edges":[
        {
            "id":"753893dc-8d59-4e45-b835-d58b0525dc56",
            "type":"polyline",
            "sourceNodeId":"fa8b58ef-42e5-49a7-9a31-30f45ed402d1",
            "targetNodeId":"2fc38a13-121a-4834-8ee0-ef4a86533c29",
            "startPoint":{
                "x":450,
                "y":220
            },
...
{
    // 元素节点自定义表单
    "fa8b58ef-42e5-49a7-9a31-30f45ed402d1":{
        "type":"object",
        // 表单数据
        "properties":{
            "fr-9b3p":{
    ...
    "2fc38a13-121a-4834-8ee0-ef4a86533c29":{
        "type":"object",
        "properties":{
            "fr-7svz":{
                "title":"日期区间选择",
